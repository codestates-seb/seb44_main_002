...
export default function SuccessPage() {
  ...
  return (
    <div className="flex relative justify-center items-center w-screen h-screen bg-gradient-to-r from-gradi-to to-gradi-from text-white overflow-hidden">
      <div className="flex flex-col justify-around w-96 h-full z-10">
